...
export function getDefaultStaticState(): DemoState {
  ...
  const initialAuditPackage: AuditPackage = {
    ...
    dilithiumSignature: "pqc_mldsa65_sig_7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a",
    ecdsaP256Signature: "ecdsa_p256_sig_3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b",
    ed25519Signature: "ecdsa_p256_sig_3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b",
    status: "VERIFIED",
