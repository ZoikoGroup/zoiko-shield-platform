...
/**
 * 1. Loading State: Skeleton shimmer & regional latency indicator
 */
export const LoadingState: React.FC<StateProps> = ({
  ...
  <div className="flex flex-col items-center justify-center p-12 rounded-xl border border-slate-800 bg-slate-950/60 backdrop-blur-md text-center space-y-4">
 ...
 */
export const PartialState: React.FC<StateProps & { connectorsActive?: number; connectorsTotal?: number }> = ({
  ...
  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-lg border border-amber-500/30 bg-amber-500/10 text-amber-200 gap-4">
...
export const StaleState: React.FC<StateProps> = ({
  ...
  <div className="flex items-center justify-between p-3 rounded-lg border border-slate-700/50 bg-slate-900/80 text-slate-300">
...
export const DegradedState: React.FC<StateProps & { fallbackReason?: string }> = ({
  ...
  <div className="p-4 rounded-lg border border-yellow-500/30 bg-yellow-950/30 text-yellow-200 space-y-1.5">
 ...
 */
export const UnauthorizedState: React.FC<StateProps & { onStepUpAuth?: () => void }> = ({
  ...
  <div className="flex flex-col items-center justify-center p-8 rounded-xl border border-rose-900/40 bg-rose-950/20 text-center space-y-3">
 ...
 */
export const UnavailableState: React.FC<StateProps> = ({
  ...
  <div className="flex flex-col items-center justify-center p-8 rounded-xl border border-red-900/50 bg-red-950/30 text-center space-y-3">
    ...
    <div className="flex items-center gap-4 text-[11px] font-mono text-slate-400">
      <span>RTO Target: &lt; 30s [derived]</span>
      <span>•</span>
      <span>RPO Target: 0s [spec]</span>
    </div>
    {retryAction && (
      <button
        onClick={retryAction}
 ...
 */
export const RecoveryState: React.FC<StateProps & { rollbackStage?: string; progressPercent?: number }> = ({
  ...
  <div className="p-4 rounded-xl border border-blue-500/30 bg-blue-950/30 text-blue-200 space-y-3">
    ...
    <div className="text-[10px] font-mono text-blue-400/80">Stage: {rollbackStage}</div>
  </div>
);
