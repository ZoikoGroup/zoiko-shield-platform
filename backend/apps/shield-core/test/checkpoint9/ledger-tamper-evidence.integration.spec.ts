...
describe('Checkpoint 9 - Ledger Tamper-Evidence Integration Suite (§08)', () => {
  ...
  const testLeaves: EvidenceLeaf[] = [
    {
      ...
      payloadDigest:
        '42e40754484f33ba20d0eb3f18a228f4a3e7b3c2918237482910384729102837',
    ...
    },
    {
      ...
      payloadDigest:
        '8f3b198c2274ad9910c2e391b8a472c199831123984719284719283746192837',
    ...
    },
    {
      ...
      payloadDigest:
        'c1852cc7cd42fc54d89a2b7190e3419088192209182736451928374619283746',
    ...
    },
    {
      ...
      payloadDigest:
        '230859eadba14f7389ab2201994ce38171092837461928374619283746192837',
  ...
  describe('1. Batch Sealing & Merkle Root Determinism', () => {
    ...
    it('should generate valid dual signatures using ML-DSA-65 and ECDSA P-256', async () => {
      const checkpoint =
        await checkpointer.buildEpochCheckpointAsync(testLeaves);
      ...
      const verification = pqcSigner.verifyHybrid(
  ...
  describe('3. Tamper-Evidence Negative Proving', () => {
    it('should FAIL proof verification if a single character of payload digest is altered', () => {
      ...
      const tamperedProof = {
        ...proof,
        leafHash:
          proof.leafHash.slice(0, -1) +
          (proof.leafHash.endsWith('0') ? '1' : '0'),
      };
