...
import { TwoPlaneIsolationGuard, PLANE_METADATA_KEY } from './two-plane-isolation.guard';
...
describe('TwoPlaneIsolationGuard (ZS-COM-BILL-001 §3 & QA-01 Separation Doctrine)', () => {
  ...
  function createMockContext(plane: string | undefined, headers: any = {}, body: any = {}): ExecutionContext {
  ...
  it('allows normal Plane 1 commercial requests from standard commercial callers', () => {
    const ctx = createMockContext('PLANE_1_COMMERCIAL', {
