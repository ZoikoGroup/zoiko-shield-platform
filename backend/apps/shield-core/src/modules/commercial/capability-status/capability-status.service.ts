...
export class CapabilityStatusService {
  ...
  private readonly publicServices: PublicServiceDefinition[] = [
    {
      ...
      publicOutcomeDescription: 'Automated continuous evaluation of security controls against approved regulatory baselines (SOC 2 Type II CC6.1, ISO/IEC 27001:2022 A.9.2) with tamper-evident evidence linkage.',
      status: 'CORE',
    ...
    },
    {
      ...
      publicOutcomeDescription: 'Immutable SHA-256 Merkle-tree checkpointing with offline, zero-network verifiable audit package generation and CLI verifier.',
      status: 'CORE',
    ...
    },
    {
      ...
      publicOutcomeDescription: 'Normalized OCSF schema security event streaming across Microsoft Entra ID, AWS CloudTrail, Google Workspace, CrowdStrike, and Okta.',
      status: 'CORE',
    ...
    },
    {
      ...
      publicOutcomeDescription: 'Continuous discovery, asset graph inventory, attack path visualization, and risk factor scoring for cloud and identity assets.',
      status: 'CORE',
    ...
    },
    {
      ...
      category: 'Security Operations',
      publicOutcomeDescription: 'Real-time threat detection rule engine, alert deduplication, anomaly scoring, and automated case timeline aggregation.',
      status: 'CORE',
    ...
    },
    {
      ...
      publicOutcomeDescription: 'Pre-simulated, idempotency-backed remediation playbooks with two-man quorum gates and circuit-breaker rollback guarantees.',
      status: 'CONTROLLED',
    ...
    },
    {
      ...
      category: 'Incident Response',
      publicOutcomeDescription: 'Contractual emergency surge retainer with SLA response windows, purpose-bound legal access reasons, and immutable counsel-controlled record protection.',
      status: 'CONTROLLED',
    ...
    },
    {
      ...
      publicOutcomeDescription: 'Domain-differentiated AI governance featuring dual-model consensus verification, evidence-grounded hypothesis validation, and model armor filtering.',
      status: 'CORE',
    ...
    },
    {
      ...
      category: 'Security Operations',
      publicOutcomeDescription: 'Multi-hop graph trajectory exploration, MITRE ATT&CK correlation, and streaming threat hypothesis validation.',
      status: 'CORE',
      substantiatingComponents: ['shield-ai', 'shield-core'],
    ...
    },
    {
      ...
      category: 'Governance, Risk & Compliance',
      publicOutcomeDescription: 'Tailored sector-specific compliance overlays (FinTech, Telecom, Healthcare, Legal, SaaS, Public Sector) subject to regional release approval.',
      status: 'GATED',
      substantiatingComponents: ['shield-core'],
    ...
    {
      serviceId: 'SVC-12',
      serviceName: 'Advanced Regulatory Frameworks (DORA, NIS2, PCI DSS v4.0.1)',
      category: 'Governance, Risk & Compliance',
      publicOutcomeDescription: 'Specialized European Digital Operational Resilience (DORA), NIS2 Directive, and PCI DSS v4.0.1 evaluators.',
      status: 'DEFERRED',
      substantiatingComponents: ['shield-core'],
  ...
  private readonly capabilities: CapabilityItem[] = [
    // 1. Ingestion & Connectivity Domain
    {
      ...
      governanceRationale: 'Fully certified Tier 1 connector stream processor with DLQ replay quarantine.',
    },
    {
      id: 'CAP-CONN-01',
      ...
      governanceRationale: 'Certified Tier 1 connectors with automated HMAC authentication and token rotation.',
    },
    {
      id: 'CAP-CONN-02',
      ...
      status: 'CORE',
      substantiatingSatellites: ['shield-core', 'shield-ingest'],
      governanceRationale: 'Partner-verified connectors active with standard telemetry ingestion SLAs.',
    },
    {
      id: 'CAP-CONN-03',
      ...
      status: 'GATED',
      substantiatingSatellites: ['shield-core', 'shield-ingest'],
      governanceRationale: 'Experimental connectors gated behind explicit tenant activation approval.',
    },
    ...
    // 2. Continuous Assurance & Evidence Domain
    {
      ...
      governanceRationale: 'Active core continuous assurance baseline evaluating logical access and access reviews.',
    ...
    },
    {
      ...
      status: 'CORE',
      substantiatingSatellites: ['shield-core'],
      governanceRationale: 'Active core continuous assurance baseline evaluating user provisioning and deprovisioning.',
    ...
    },
    {
      ...
      governanceRationale: 'Tamper-evident append-only ledger sealing epoch checkpoints with Merkle roots.',
    },
    {
      id: 'CAP-VERIF-01',
      ...
      governanceRationale: 'Standalone zero-dependency CLI verifying audit packages against local Merkle proofs.',
    },
    {
      id: 'CAP-FRAME-01',
      ...
      status: 'DEFERRED',
      substantiatingSatellites: ['shield-core'],
      governanceRationale: 'Deferred to Phase 2 midpoint per ADR-08. Schema present in sector pack registry in DEFERRED status.',
    ...
    // 3. Managed Detection & Response (MDR) Domain
    {
      ...
      status: 'CORE',
      substantiatingSatellites: ['shield-core', 'shield-ingest'],
      governanceRationale: 'In-memory sliding window threat correlation and pattern matching.',
    },
    {
      id: 'CAP-DETECT-02',
      ...
      status: 'CORE',
      substantiatingSatellites: ['shield-core'],
      governanceRationale: 'Cross-cloud asset identity resolution and anomaly scoring.',
    },
    {
      id: 'CAP-CASE-01',
      ...
      status: 'CORE',
      substantiatingSatellites: ['shield-core'],
      governanceRationale: 'Comprehensive case tracking, analyst notes, and evidence linkage.',
    },
    ...
    // 4. SOAR Remediation & Response Domain
    {
      ...
      governanceRationale: 'Dry-run execution sandbox generating cryptographically signed execution receipts.',
    },
    {
      id: 'CAP-ACTION-02',
      ...
      governanceRationale: 'High-impact remediation actions require multi-party approval quorum and circuit-breaker rollback.',
      requiresQuorum: true,
    },
    ...
    // 5. Emergency Incident Response Retainer Domain
    {
      ...
      status: 'CORE',
      substantiatingSatellites: ['shield-core'],
      governanceRationale: 'Guaranteed 1-hour / 4-hour SLA emergency response windows with consumption ledger.',
    },
    {
      id: 'CAP-IR-02',
      ...
      status: 'CONTROLLED',
      substantiatingSatellites: ['shield-core'],
      governanceRationale: 'Mandatory accessReason enforcement and tamper-evident audit logging for privilege-claimed forensics.',
    ...
    // 6. AI Security Governance Domain
    {
      ...
      governanceRationale: 'AI investigations verified against factual evidence ledger ground truth before acceptance.',
    },
    {
      id: 'CAP-AI-02',
      ...
      governanceRationale: 'Requires secondary consensus verification for high-severity threat hypotheses.',
    },
    {
      id: 'CAP-AI-03',
      ...
      status: 'CORE',
      substantiatingSatellites: ['shield-ai'],
      governanceRationale: 'Sanitizes all LLM prompts and model responses for prompt-injection and PII redaction.',
    },
    {
      id: 'CAP-HUNT-01',
      ...
      status: 'CORE',
      substantiatingSatellites: ['shield-ai', 'shield-core'],
      governanceRationale: 'Graph-based traversal mapping lateral movement opportunities across cloud assets.',
    },
    ...
    // 7. Sector Packs & Experimental Crypto Domain
    {
      ...
      status: 'GATED',
      substantiatingSatellites: ['shield-core'],
      governanceRationale: 'Gated behind legal interpretation, SME review, content license, and regional availability approval.',
    },
    {
      id: 'CAP-CRYPTO-01',
      ...
      status: 'CONTROLLED',
      substantiatingSatellites: ['shield-anchor'],
      governanceRationale: 'Dual-signing active in parallel with standard Ed25519/ECDSA.',
    },
    {
      id: 'CAP-CRYPTO-02',
      ...
      status: 'GATED',
      substantiatingSatellites: ['shield-core'],
      governanceRationale: 'Parked in isolated experimental module per ADR-017 until G1 release approval.',
    },
  ];
  ...
  getCapabilitiesByDomain(): CapabilityDomainSummary[] {
    ...
    const domainDescriptions: Record<string, string> = {
      INGESTION_CONNECTIVITY: 'High-throughput OCSF security event streaming and multi-tier connector lifecycle management.',
      ASSURANCE_EVIDENCE: 'Automated continuous control evaluation and tamper-evident Merkle evidence checkpointing.',
      MANAGED_DEFENSE: 'Real-time threat detection, anomaly scoring, and case management.',
      SOAR_RESPONSE: 'Human-in-the-loop playbook orchestration with two-man quorum and rollback safety.',
      INCIDENT_RETAINER: 'SLA-guaranteed emergency response surge with purpose-bound legal record access.',
      AI_GOVERNANCE: 'Dual-model consensus validation, evidence grounding gates, and model armor defenses.',
      SECTOR_PACKS: 'Specialized regulatory and compliance overlays with regional market release gating.',
      EXPERIMENTAL_CRYPTO: 'PQC dual-signing and cryptographic trust attestation.',
    };
  ...
  isConnectorAvailable(connectorKey: string): boolean {
    const gatedConnectors = ['sap-enterprise-gated', 'custom-grpc-experimental'];
