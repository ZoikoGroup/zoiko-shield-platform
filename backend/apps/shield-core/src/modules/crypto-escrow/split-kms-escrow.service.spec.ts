...
describe('SplitKmsEscrowService', () => {
  ...
  it('should generate split master key across 3 cloud providers and reconstruct exact plaintext key', () => {
    ...
    const config = {
      ...
      azureKeyVaultUri: 'https://sovereign-vault.vault.azure.net/keys/azure-root-key',
      gcpKmsKeyName: 'projects/p/locations/europe-west3/keyRings/r/cryptoKeys/gcp-root-key',
    };
