...
const G1_CONTRACTS: Contract[] = [
  ...
  { id: 'W04', title: 'Notification center and acknowledgment', route: '/notifications' },
  ...
  { id: 'W11', title: 'Audit and privileged-activity explorer', route: '/audit' },
  {
    ...
    route: null,
    note: 'Partially blocked: only commercial approvals and detection publish/disable exist. There is no generic policy version, diff, staged deployment or rollback API to build against.',
  },
  { id: 'W13', title: 'Alert queue', route: '/alerts' },
  { id: 'W14', title: 'Alert detail', route: '/alerts/[alertId]' },
  { id: 'W15', title: 'Detection content management', route: '/detections' },
  ...
  { id: 'W17', title: 'Response action proposal and approval', route: '/actions' },
  {
    ...
    route: null,
    note: 'Blocked on the backend: there is no playbook API at all. Nothing to integrate until one exists.',
  },
  { id: 'W21', title: 'Framework and control library', route: '/controls' },
  { id: 'W22', title: 'Control detail', route: '/controls/[controlId]' },
  { id: 'W23', title: 'Evidence object viewer', route: '/ledger' },
  { id: 'W24', title: 'Evidence operations queue', route: '/evidence-operations' },
  ...
  { id: 'W34', title: 'AI proposal card pattern', route: '/response-proposals' },
